...
public:
	...
	int Setup(cVirtualDirectoryMap *pVirtualDirectoryMap, cScriptEngine *pScriptEngine, cIMsgQueue *pMsgQueue, cIMsg *pMessage);
...
private:
	...
	std::string m_sInterpreterNamespace;
	cMIMEMap m_MIMEMap;
	bool m_bWebPage;
