...
public:
	...
	void UsingDatabase(bool state) { m_ifUsingDatabase = state; }
	bool IsUsingDatabase() { return m_ifUsingDatabase; }
	...
	cPresence  *GetPresence() { return &m_Presence; }
	cService   *GetService() { return &m_Service; }

	cPeerRoutingMap *GetPeerRoutingMap() { return &m_PeerRoutingMap; }
...
private:
	...
	std::string m_DatabaseFlushInterval;
	std::string m_DatabaseName;
	std::string m_PluginDirectory;
	std::string m_PluginExtension;
	std::string m_DotPath;
	std::string m_DotFilesPath;
	cIPAccess m_IPAccess;

	cMsgCourier m_MsgCourierInternalCommandHandler;

	cWebServer *m_pWebServer;

	cTSZScraper *m_pTSZScraperServer;
	cDownloadManager *m_pDownloadManager;
	cAutoUpdate *m_pAutoUpdateManager;
	...
	cPeerRoutingMap m_PeerRoutingMap;
