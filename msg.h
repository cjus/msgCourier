...
public:
	...
	//void SetHeader(const char *pHeader, int iHeaderLength);
	...
	void SetRemoteHandler(cServiceEntry *pService);
	cServiceEntry *GetRemoteHandler();
...
//	cSExpr MsgSExpression;		// S-Sxpression
	cServiceEntry *MsgService;	// message will be processed by external handler
