...
{
public:
    cConnectionQueue(cMsgQueue *pMsgQueue, cPeerRoutingMap *pPeerRoutingMap, int iConnectionTimeout);
    ~cConnectionQueue();
	...
	void SetAccessLog(cAccessLog *pAccessLog) { m_pAccessLog = pAccessLog; }
	cMsgQueue *GetMsgQueue() { return m_pMsgQueue; }
	cPeerRoutingMap *GetPeerRoutingMap() { return m_pPeerRoutingMap; }
	cSysMetrics *GetSysMetrics() { return m_pSysMetrics; }
	cAccessLog *GetAccessLog() { return m_pAccessLog; }
...
private:
	...
	cPeerRoutingMap *m_pPeerRoutingMap;
